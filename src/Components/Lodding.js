...
function Lodding() {
  return (
    <div className="w-full h-[100vh] flex justify-center items-center relative z-50">
      <div className="w-full h-full absolute left-0 top-0 [@media(min-width:600px)]:flex hidden justify-center items-center text-center z-0">
        <PuffLoader color="#03c0ff39" size={140} className="flex justify-center items-center text-center" />
      </div>
      <div className="w-full h-full absolute left-0 top-0 [@media(min-width:600px)]:hidden flex justify-center items-center text-center z-0">
        <PuffLoader color="#03c0ff39" size={120} className="flex justify-center items-center text-center" />
      </div>
